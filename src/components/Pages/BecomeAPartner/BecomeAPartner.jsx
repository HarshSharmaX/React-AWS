    ...
    return(
        ...
        <div className='bap container'>
            ...
            <div className="col-11 mb-2 mt-md-5 mt-3 ml-4">
                ...
                <input type="text" class="form-control mt-2 bInput" id="BAPStoreName" onChange={(e)=>{setStoreName(e.target.value)}} />
            </div>
            <div class="col-11 mb-2 mt-3">
                <label for="BAPStoreName" class="col-form-label bLabel">Owner Name</label>
                <input type="text" class="form-control mt-2 bInput" id="BAPStoreName" onChange={(e)=>{setOwnerName(e.target.value)}} />
            </div>
            <div class="col-11 mb-2 mt-3">
                <label for="BAPStoreName" class="col-form-label bLabel">Store Address</label>
                <input type="text" class="form-control mt-2 bInput" id="BAPStoreName" onChange={(e)=>{setStoreAddress(e.target.value)}} />
            </div>
            <div class="col-11 mb-2 mt-3">
                <label for="BAPStoreName" class="col-form-label bLabel">Contact No.</label>
                <input type="number" class="form-control mt-2 bInput" id="BAPStoreName" onChange={(e)=>{setContact(e.target.value)}}/>
            </div>
            <div class="col-11 mb-2 mt-3">
                <label for="BAPStoreName" class="col-form-label bLabel">City</label>
                <input type="text" class="form-control mt-2 bInput" id="BAPStoreName" onChange={(e)=>{setCity(e.target.value)}} />
            </div>
            <div class="col-11 mb-2 mt-3">
                <label for="BAPStoreName" class="col-form-label bLabel">Locality</label>
                <input type="text" class="form-control mt-2 bInput" id="BAPStoreName" onChange={(e)=>{setLocality(e.target.value)}}/>
            </div>
            <button class=" mt-4 mb-3 bapBtn" onClick={() => bapData()} >Submit</button>
            </form>
