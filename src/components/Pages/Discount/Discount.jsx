...
const FivePercent = (props) => {
  ...
  const DiscountLink = Link.split("/").pop();
  let FinalLink = DiscountLink;
  console.log("URL",DiscountLink);
  if(DiscountLink == "Gold?"){
    FinalLink = DiscountLink.slice(0,-1);
  }

  if(DiscountLink == "Platinum?"){
    FinalLink = DiscountLink.slice(0,-1);
  }

  console.log("FinalURL",FinalLink);
  ...
  return (
    <div className="p-10">
      ...
      <div className="shorting_title_wrap mb-md-4 mb-3">
        {FinalLink == "Gold"? <h1 className="common_header">5% Discount</h1> : <h1 className="common_header">10% Discount</h1>}
