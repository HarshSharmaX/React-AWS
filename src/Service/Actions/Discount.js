import {
  ...
  export const vendorData = (Package) => {
    return (dispatch) => {
      dispatch({
        type: VENDOR_REQUEST,
        payload: {},
      ...
      return axios
        .get(`https://kubeshop.in:8080/api/v1/rl7nuo0GNHFAvhTL/stores/all?seasonkey=${Package}`)
        .then((res) => {
          dispatch({
            type: VENDOR_SUCCESS,
            payload: res.data,
  ...
  export const filterVendorData = ( season) => {
    ...
    return (dispatch) => {
      ...
      return axios
        .get(`https://kubeshop.in:8080/api/v1/rl7nuo0GNHFAvhTL/stores/all?seasonkey=${season}`, {
         /* params: {
            city: city,
            locality: locality == 'All Locality' ? null: null,
          },*/
        })
        .then((res) => {
          dispatch({
  ...
  export const getReviewRequest = (perticularVendorId) => {
    return (dispatch) => {
      ...
      return axios
        .get(
          `https://kubeshop.in:8080/api/v1/rl7nuo0GNHFAvhTL/stores/all?package=Platinum?_id=` +
          perticularVendorId
        )
        .then((res) => {
          dispatch({
